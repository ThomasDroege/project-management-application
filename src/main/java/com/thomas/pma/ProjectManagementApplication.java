...
public class ProjectManagementApplication {
	...
	// to prevent from running into "unique id"-bug
	/*
	 * @Bean CommandLineRunner runner() {
	 * 
	 * return args -> {
	 * 
	 * Employee emp1 = new Employee("John", "Warton", "warton@gmail.com"); Employee
	 * emp2 = new Employee("Mike", "Lanister", "lanister@gmail.com"); Employee emp3

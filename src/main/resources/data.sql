-- INSERT EMPLOYEES			
insert into employee (employee_id, firstname, lastname, email) values (1, 'John', 'Warton', 'warton@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (2, 'Mike', 'Lanister', 'lanister@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (3, 'Steve', 'Reeves', 'Reeves@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (4, 'Ronald', 'Connor', 'connor@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (5, 'Jim', 'Salvator', 'Sal@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (6, 'Peter', 'Henley', 'henley@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (7, 'Richard', 'Carson', 'carson@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (8, 'Honor', 'Miles', 'miles@gmail.com');
insert into employee (employee_id, firstname, lastname, email) values (9, 'Tony', 'Roggers', 'roggers@gmail.com');
